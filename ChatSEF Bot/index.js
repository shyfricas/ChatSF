...
function sendMessage() {
    ...
    // if message = developer (show our message)
        ...
        setTimeout(() => {
            ...
            appendMessage('bot', 'This Source was Coded By:\nShaliah Fricas :)');
    ...
    const options = {
	    ...
	    headers: {
		    ...
		    'X-RapidAPI-Key': 'e34c9e6c90mshc5d7e286e3776e9p16990ejsn828c4da828cf',
		    'X-RapidAPI-Host': 'chatgpt53.p.rapidapi.com'
            // if you want use offical aip
            /*
            'content-type': 'application/json',
		    'X-RapidAPI-Key': 'e34c9e6c90mshc5d7e286e3776e9p16990ejsn828c4da828cf',
        ...
        //use backtick `, not apostrophe '
        //if you want use official api you need to have this body
...
function appendMessage(sender, message) {
    ...
    // changes send button icon to loading using fontawesome
